...
function validateForm(register) {
    const schema = Joi.object({
        ...
        gender: Joi.string().empty().required().valid('female','male').messages({
        ...
        city: Joi.string().empty().required().valid('rajkot','supedi','ahmdabad').messages({
            "string.base": `City should be a type of text`,
            "string.empty": 'City  is not allowed to be empty',
            "string.required": `city is Required`,
        }),
        hobby: Joi.string().empty().required().valid('cooking','dancing','travelling').messages({
...
function logingForm(loging) {
    ...
    function editProfile(editProfile) {
        ...
        return schema.validate(editProfile, { abortEarly: false });
    }
